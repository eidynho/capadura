            ...
            <div className="flex gap-8 text-black dark:text-white">
                <div className="w-2/3">
                    ...
                    <Subtitle className="mt-6">
                        ...
                        livros incríveis? Na nossa comunidade de amantes da leitura, cada novo
                        membro enriquece nossa experiência compartilhando suas histórias literárias
                        favoritas.
                    </Subtitle>

                    <Subtitle className="mt-4">
                        Ajude-nos a expandir nosso universo de livros e amizades. Convide seus
                        amigos agora e juntos vamos descobrir novos livros.
                    </Subtitle>
