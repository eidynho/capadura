...
import { CardUserRead } from "./components/CardUserRead";
...
export default function UserReads({ params }: UserReadsProps) {
    ...
    return (
        <>
            <Title>{isCurrentUser ? "Minhas leituras" : `Leituras de ${params.username}`}</Title>
            {isCurrentUser && <Subtitle>Acompanhe todas suas leituras.</Subtitle>}

            <Separator className="my-6" />

            <div className="flex flex-col justify-center">
                <Tabs value={currentTab} onValueChange={onTabChange} defaultValue="account">
                    <TabsList>
